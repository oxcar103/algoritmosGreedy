...
Este problema consiste en hallar, para unas listas de trabajos y trabajadores dadas, la asignación que reduce el costo total correspondiente a que cada trabajador realice cierto trabajo. Se pueden diseñar varias heurísticas de tipo Greedy para hallar soluciones al problema
