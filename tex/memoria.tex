...
\section{Red de comunicaciones}
  \subsection{Algoritmo}
    ...
    Varios algoritmos para calcular el árbol recubridor minimal son conocidos. Ambos alcanzan una complejidad temporal de $\mathcal{O}(|E|log|V|)$ usando árboles binarios y
